...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in get(name, envir = asNamespace(pkg), inherits = FALSE): object 'ggplot2.criterion\_distribution' not found}}\end{kframe}
\end{knitrout}
}
\end{columns}
\end{block}
