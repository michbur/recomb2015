...
\date{}
\author{Micha\l{}Ç  Burdukiewicz\inst{1}*, Piotr Sobczyk\inst{2}, Pawe\l{}Ç  B\l{}a\.{z}ej\inst{1}, Pawe\l{}Ç Mackiewicz\inst{1} \\
...
%       University of Wroc≈Çaw & Wroc≈Çaw University of Technology
%   \end{tabular}  
% }
